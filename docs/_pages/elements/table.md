...
<script>
    $('#exampleButton-1').on('click', function() {
        YOI.element.Table.select($('#exampleTable-1 tr').eq(1));
    });
</script>
```
...
<script>
    $('#exampleButton-2').on('click', function() {
        YOI.element.Table.unselect($('#exampleTable-2 tr').eq(1));
    });
</script>
```
...
<script>
    $('#exampleButton-3').on('click', function() {
        YOI.element.Table.remove($('#exampleTable-3 tr').eq(1));
    });
</script>
```
...
<script>
    ...
    $('#exampleTable-4').on('yoi-table:select', function() {
        YOI.element.Log.write($('#myLog'), 'yoi-table:select');
    });
    $('#exampleTable-4').on('yoi-table:unselect', function() {
        YOI.element.Log.write($('#myLog'), 'yoi-table:unselect');
    });
    $('#exampleTable-5').on('yoi-table:remove', function() {
        YOI.element.Log.write($('#myLog'), 'yoi-table:remove');
    });
    $('#exampleTable-5').on('yoi-table:empty', function() {
        YOI.element.Log.write($('#myLog'), 'yoi-table:empty');
    });
    
    // bind methods to buttons on click
    
    $('#exampleButton-4').on('click', function() {
        YOI.element.Table.select($('#exampleTable-4 tr').eq(1));
    });
    $('#exampleButton-5').on('click', function() {
        YOI.element.Table.unselect($('#exampleTable-4 tr').eq(1));
    });
    $('#exampleButton-6').on('click', function() {
        YOI.element.Table.remove($('#exampleTable-5 tr').eq(1));
    });
