...
<div class="p-2 pos-absolute w-1-1 al-r">
    ...
    <a href="{{ site.github.zip_url }}" class="btn btn--medium btn--subtle">Download</a>
</div>

<!-- section intro -->

<section id="intro" class="cover only-s--h-auto only-s--p-tb-15 l--p-tb-30 center bg-base-25">
    <div class="wrapper al-c op-transparent" yoi-scrollfx="in:fade-in; speed:slow; repeat:false;">
        ...
        <div class="m--w-40 m-lr-auto m-t-4">
            <p class="fs-4 lh-6 m-tb-8">Yoi is a modular front-end library with a simple HTML-interface.</p>
            <p>
                <a class="fs-2 only-s--d-block tdr-none hvr--tdr-underline" href="{{ site.github.url }}/start/">Read to the docs</a>
                <i class="fs-2 c-base-15 m-lr-2 only-s--d-block only-s--m-tb-2">or</i>
                <a class="btn btn--primary btn--large btn--flat" href="#build" yoi-action="ScrollTo:#build; offset:0;">Learn more!</a>
            </p>
        </div>
    </div>
</section>
<img class="bg-white h-3 d-block w-1-1" src="{{ site.github.url }}/assets/img/divider-dark.svg" />
...
<section id="build" class="p-tb-15 l--p-tb-30 article bg-white pos-relative">
    <div class="wrapper">
        <div class="flx flx-directionColumn m--flx-directionRow">
            <div class="m--w-1-3 w-1-1 p-r-6 pos-relative" yoi-scrollfx="in:slide-in-bottom; speed:1; repeat:false;">
                <h2 class="fs-9 al-r">Build</h2>
            </div>
            <div class="m--w-2-3 w-1-1" yoi-scrollfx="in:slide-in-bottom; speed:4; repeat:false;">
...
<section id="tweak" class="p-tb-15 l--p-tb-30 article bg-white pos-relative">
    <div class="wrapper" yoi-scrollfx="in:fade-in; repeat:false;">
        <div class="flx flx-directionColumn m--flx-directionRow">
            <div class="m--w-1-3 w-1-1 p-r-6 pos-relative">
                <h2 class="fs-9 al-r">Tweak</h2>
            </div>
...
```html
<!-- example:tabs -->
<div class="pos-relative h-50">
    <img class="pos-absolute z-2" src="https://source.unsplash.com/as5uuSv4F84/240x400" alt="" yoi-parallax="factor:-10;" />
    <span class="pos-absolute bg-purple-10 w-24 h-40 m-l-5 m-t-5 z-1" yoi-parallax="factor:-20;"></span>
    <p class="w-1-1 pos-br m-b-10 b-b bw-2 p-b-6 bc-purple-10 z-3" yoi-scrollfx="in:slide-in-bottom; speed:slow;">
        <span class="d-block m--w-1-2 m--fl-none w-1-1 fl-r">
            <span class="d-block ff-mono fs-3 lh-4 c-purple-10">You don’t <i>take</i> a photograph. You ask quietly to borrow it.</span>
            <span class="btn btn--medium btn--flat btn--primary m-t-4">shop this style</span>
        </span>
    </p>
</div>
```
